...
import { openStudentWhatsAppReport } from '@/lib/whatsapp';
                          ...
                          <tr key={ts.id}>
                            ...
                            <td>
                              <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
                                <button
                                  type="button"
                                  onClick={() => openStudentWhatsAppReport({
                                    ...ts,
                                    teacherName: selectedStaff?.name || ts.teacherName,
                                    type: selectedStaff?.type === 'trainer' ? 'trainee' : 'student'
                                  })}
                                  title={`إرسال التقرير الشامل لـ ${ts.name} على واتساب`}
                                  style={{
